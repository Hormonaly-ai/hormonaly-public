...
> >    3. 3. [Partner API Reference](#partner-api-reference)
> >       4. 4. [MCP Server — Tool Schema](#mcp-server--tool-schema)
> >          5. 5. [Authentication](#authentication)
> >             6. 6. [Rate Limits & Quotas](#rate-limits--quotas)
> >                7. 7. [Subscription Tiers](#subscription-tiers)
> >                   8. 8. [Scribe API](#scribe-api)
> >                      9. 9. [Security & Compliance](#security--compliance)
> >                         10. 10. [Getting Access](#getting-access)
> >                            
> >                             11. ---
> >                            
> >                             12. ## Platform Overview
> >                            
> >                             13. Hormonaly combines three pillars into one platform:
> >
...
> > data: {"type":"metadata","evidence_grade":"C","confidence":62,"citations":5,"sources_consulted":26}
> > data: {"type":"done"}
> > ```
> >
...
> > ---
> >
> > #### `GET /api/v1/helix/protocols/:compound`
> >
> > Look up evidence-quality-rated protocols for a specific compound.
> >
> > **Example:** `GET /api/v1/helix/protocols/bpc-157`
> >
> > **Response:**
> >
> > ```json
...
> >
> > Poll with `GET /api/v1/helix/dossier/:job_id` until `status: "complete"`.
> >
> > ---
> >
> > #### `POST /api/v1/helix/compare`
> >
...
> > ```bash
> > # 1. Clone and build
> > cd mcp/hormonaly-mcp-server && npm install && npm run build
> >
...
> >     "hormonaly": {
> >       "command": "node",
> >       "args": ["/path/to/mcp/hormonaly-mcp-server/dist/index.js"],
> >       "env": {
...
> > }
> >
> > # 3. Restart Claude Desktop — tools appear immediately
> > ```
> >
...
> >
> > ```
> > Key display in portal: hk_live_1055...  (masked prefix — visual reference only)
> > ```
> >
...
> > Lost key → revoke + create new — no plaintext recovery
> > ```
> >
> > ---
> >
...
> > >     - - **Audit logging** — All auth events, API key usage, AI calls, and admin actions written to tamper-evident audit log
...
> > >   - - **Quality benchmarks (May 2026):**
> > >    
> > >     - | Dimension | Score |
> > >     - |---|---|
> > >     - | Answer accuracy | 100% |
> > >     - | Safety block rate | 96% |
> > >     - | RAG retrieval pass rate | 99% |
> > >     - | Citation faithfulness | 3% hallucinated (PMID-verified) |
> > >    
> > >     - ### Uptime
> > >    
